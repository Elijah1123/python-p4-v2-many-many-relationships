...
# Association table for the many-to-many relationship between Employee and Meeting
...
class Assignment (db.Model):
    ...
    employee_id = db.Column(db.Intrger, db.ForeignKey('employees.id'))
    project_id = db.Column(db.Integer, db.ForeignKey('projects.id'))

    emmployee = db.relationship('Employee', back_populates='assignments')
